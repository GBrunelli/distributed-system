...
const runKafka = async () => {
	...
	await consumer.subscribe({ topic: 'fila-requisicoes', fromBeginning: true });
...
app.use('/prescricao-medicamentos', prescricaoMedicamentosRoutes(pgClient, producer));
app.use('/medicamento-disponiveis', medicamentoDisponiveisRoutes(pgClient, producer));
